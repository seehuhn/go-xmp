...
// A Token is an interface holding one of the token types: [xml.StartElement],
// [xml.EndElement], [EmptyElement], [xml.CharData], [xml.Comment],
// [xml.ProcInst], or [xml.Directive].
type Token any
